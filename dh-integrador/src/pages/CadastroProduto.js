...
const CadastroProduto = () => {
  ...
  useEffect(() => {
    ...
    const response = await axios.get('http://3.92.126.107:5000/cidade');
  ...
  useEffect(() => {
    ...
    const response = await axios.get('http://3.92.126.107:5000/categoria');
  ...
  useEffect(() => {
    ...
    const response = await axios.get('http://3.92.126.107:5000/caracteristica', {
  ...
  const handleSubmitImagem = async (e) => {
    ...
    try {
      const response = await axios.post('http://3.92.126.107:5000/imagem', data, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://3.92.126.107:5000/produto', data, {
        headers: { Authorization: `Bearer ${token}` },
      });
