...
//        List<ReservaModel> reservaModelList = repository.findByConsultaReserva(reservaDTO.getProduto().getIdProduto(),reservaDTO.getDataInicioReserva() ,reservaDTO.getDataFinalReserva());
//        List<ReservaModel> reservaModelList1 = repository.findByConsultaReserva1(reservaDTO.getProduto().getIdProduto(),reservaDTO.getDataInicioReserva() ,reservaDTO.getDataFinalReserva());
        ReservaModel reserva = mapper.convertValue(reservaDTO,ReservaModel.class);
//        logger.info(reservaModelList);
//        if (!reservaModelList.isEmpty() || !reservaModelList1.isEmpty()) {
//            logger.error("Este produto já esta reservado nessa data");
//            throw new ResourceConflict("Produto indisponivel para essa data");
//        }
//        logger.info(reservaModelList);


//        if (!produtoService.hasConflict(id, dataInicial, dataFinal)){
//            logger.error("Este produto já esta reservado nessa data");
//            throw new ResourceConflict("Produto indisponivel para essa data");
//        }
