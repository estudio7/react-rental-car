...
//        List<ProdutoModel> ListProduto = reservaRepository.findByCidadeAndDatas(cidade,dataInicio,dataFim);
...
//    public Boolean hasConflict(Long idProduto, Date dataInicial, Date dataFinalfim) throws ResourceConflict {
//        List<ProdutoModel> ModelList = repository.findByConsulta(idProduto,dataInicial,dataFinalfim);
//        List<ProdutoModel> reservaModelList1 = repository.findByConsulta1(id,inicio,fim);
